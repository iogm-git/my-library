...
//     wrapper = document.querySelector('.wrapper'), pos,
...
//     lastElement = elements[elementsLength - 1],
//     cloneFirst = firstElement.cloneNode(true),
//     cloneLast = lastElement.cloneNode(true),
//     index = 0
...
//     items.insertBefore(cloneLast, firstElement);

//     // Move
//     setInterval(function () {
//         items.classList.add('shifting');
//         pos = items.offsetLeft
//         items.style.left = (pos - elementWidth - gap) + "px"
//         index++
